const apps = [
  ...
  },
  {
    ...
    "downloadLink": "https://pixeldrain.com/u/knd4ieXE",
  ...
  },
  {
    ...
    "downloadLink": "https://1024terabox.com/s/1mCSjBvF55bGMPK4a35Hxbw",
  ...
  {
    "type": "Game",
    "logo": "https://files.catbox.moe/4mb9v9.jpeg",
    "name": "AV Director Life!",
    "os": "Windows",
    "version": "Final",
    "size": "3.2 GB",
    "description": "AV Director Life! PC",
    "downloadLink": "https://drive.usercontent.google.com/download?id=1w-IfPiHOPYISh5FPoG4CXveU7KYNAvQb&export=download&authuser=0",
    "detailDesc": "Thể loại: 18+, 3D, Main Nam, Simulation\n\nPhiên bản: Hoàn thành\n\nNgôn ngữ: Tiếng Việt\n\nDeveloper: TeamKRAMA\n\nĐược việt hóa: Capybara\n\nNội Dung Game: Đây là một tựa game mô phỏng cho phép bạn tự do quay phim, biên tập và kinh doanh sản phẩm phim AV.\n\nNhân vật chính, vì hoàn cảnh trả nợ, đã hợp tác với nữ chính – Himemiya Kazu – để cùng khám phá những kịch bản sáng tạo đầy táo bạo!\nKhi trải nghiệm game, bạn sẽ mở khóa thêm nhiều địa điểm quay phim mới và sử dụng các đạo cụ đa dạng để tạo nên những tác phẩm AV đỉnh cao! Sau khi ghi lại những cảnh quay nóng bỏng đầy dục vọng và bản năng, bạn sẽ bước vào công đoạn hậu kỳ.\n\nTrải nghiệm cắt ghép từng phân cảnh như một editor chuyên nghiệp, đồng thời tự do đặt tiêu đề, chọn thể loại, định giá… để biến tác phẩm của mình thành một kiệt tác khiêu gợi đích thực!\nCâu chuyện xoay quanh hai nhân vật chính: Takasuke Yasuda – nam chính từng là dân trong ngành AV, và nữ chính Kazu Himemiya. Mối quan hệ của họ ban đầu chỉ là đối tác làm ăn, nhưng dần dần phát triển thành một sợi dây liên kết đặc biệt.\nNgoài ra, bạn còn gặp ba nhân vật nữ phụ đầy cá tính: Maiko – đồng nghiệp cũ, Reimu – chủ cửa hàng đạo cụ, và Yuna – một người bạn thân. Tương tác với họ sẽ mang đến nguồn cảm hứng và chiều sâu mới cho những bộ phim AV của bạn!\n\nTakasuke phải đối mặt với áp lực trả nợ định kỳ 5 ngày một lần. Để xoay sở, bạn cần nhận các công việc làm thuê quanh thành phố, vừa kiếm tiền vừa duy trì hoạt động quay phim.\nCân bằng giữa sáng tạo và quản lý tài chính chính là chìa khóa thành công. Vượt qua gánh nặng nợ nần, mở rộng sự nghiệp sản xuất AV, và vươn lên trở thành đạo diễn hàng đầu!",
    "screenshots": [
      "https://files.catbox.moe/9ftmc9.jpeg",
      "https://files.catbox.moe/zue7da.jpg",
      "https://files.catbox.moe/ivjmnp.jpg",
      "https://files.catbox.moe/grolaz.jpg",
      "https://files.catbox.moe/u2elok.jpg"
    ]
  }
];